...
var token = 'patw1BfApdvasewun.e5cece4b87fc9bc014cdbdf68333fb7545c5c4b0303034d52d14f983a6ff9b50';
airtable__WEBPACK_IMPORTED_MODULE_0___default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable__WEBPACK_IMPORTED_MODULE_0___default().base('appqcanDpqVdaYzv2');
function getPostTeasers() {
  return new Promise(function (resolve, reject) {
    var content = [];
    base('netudel_articles').select({
      maxRecords: 100
...
function initSearch() {
  ...
  A_SearchDelete.addEventListener('click', function () {
    deleteSearchRequest();
  });
}
...
function createCards(content) {
  content.forEach(function (contentItem) {
    ...
    var cardArticleItemDescTags = document.createElement('div');
