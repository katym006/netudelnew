...
var token = 'pateHmCh4GAhz9UJV.0770e34ee3b1dee634a922d250dc386eff8d93933faff26b17613ad62c2d9ffa';
airtable__WEBPACK_IMPORTED_MODULE_0___default().configure({
  endpointUrl: 'https://api.airtable.com',
  apiKey: token
});
var base = airtable__WEBPACK_IMPORTED_MODULE_0___default().base('appzYp2PFjIXiifWA');
function getPostTeasers() {
  return new Promise(function (resolve, reject) {
    var content = [];
    base('netudel_hobbies').select({
      maxRecords: 100
